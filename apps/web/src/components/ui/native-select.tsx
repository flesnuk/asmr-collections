...
function NativeSelect({ className, classNames, ...props }: NativeSelectProps) {
  return (
    <div
      className={cn("group/native-select relative w-fit has-[select:disabled]:opacity-50", classNames?.wrapper)}
